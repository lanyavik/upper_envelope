...
def bc_reg_learn(env_set="Hopper-v2", buffer_seed=0, seed=0, buffer_type="FinalSigma0.5_env_0_1000K",
				 eval_freq=500, max_timesteps=int(2e5), lr=1e-3, wd=0, batch_size=1000,
				 logger_kwargs=dict()):
	...
	file_name = "BC_%s_%s_%s" % (buffer_type, env_set, seed)
	print("---------------------------------------")
	print
	("Task: " + file_name)
...
if __name__ == "__main__":
	...
	bc_reg_learn(seed=args.seed, eval_freq=args.eval_freq, max_timesteps=args.max_timesteps,
