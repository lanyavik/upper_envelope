...
from spinup.algos.BAIL_progressive import utils, algo_Prog_BAIL
...
def bail_learn(algo = 'bail_2_bah',
	...
	# Initialize policy
	if algo == 'bail_2_bah':
		policy = algo_Prog_BAIL.BAIL_selebah(state_dim, action_dim, max_action, max_iters=max_timesteps, States=states, MCrets=gts,
		...
		policy = algo_Prog_BAIL.BAIL_selebuf(state_dim, action_dim, max_action, max_iters=max_timesteps,
