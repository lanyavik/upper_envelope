...
def bcq_learn(env_fn, env_name="Hopper-v2", seed=0, buffer_type="Robust", buffer_seed=0,
			  buffer_size='100K',
			  eval_freq=float(1e3), max_timesteps=float(1e6), lr=1e-3,
			  logger_kwargs=dict()):
	...
	file_name = "BCQ_%s_%s" % (env_name, seed)
...
if __name__ == "__main__":
	...
	bcq_learn(lambda: gym.make(args.env), env_name=args.env_name, seed=args.seed, buffer_type=args.buffer_type,
