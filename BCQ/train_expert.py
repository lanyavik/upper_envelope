...
from spinup.algos.BCQ import utils, DDPG
...
if __name__ == "__main__":
	...
	parser.add_argument("--seed", default=9, type=int)					# Sets Gym, PyTorch and Numpy seeds
	...
	while total_timesteps < args.max_timesteps:
		...
		if done: 
			...
			if total_timesteps != 0:
				print(total_timesteps, episode_num, episode_timesteps, episode_reward)
